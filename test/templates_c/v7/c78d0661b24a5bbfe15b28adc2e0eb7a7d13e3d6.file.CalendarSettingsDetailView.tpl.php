<?php /* Smarty version Smarty-3.1.7, created on 2020-01-29 22:35:36
         compiled from "/srv/vtigercrm/includes/runtime/../../layouts/v7/modules/Users/CalendarSettingsDetailView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10221506935e3208b86ce419-22309056%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c78d0661b24a5bbfe15b28adc2e0eb7a7d13e3d6' => 
    array (
      0 => '/srv/vtigercrm/includes/runtime/../../layouts/v7/modules/Users/CalendarSettingsDetailView.tpl',
      1 => 1520586669,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '10221506935e3208b86ce419-22309056',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5e3208b8718b1',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5e3208b8718b1')) {function content_5e3208b8718b1($_smarty_tpl) {?>
<form id="detailView" data-name-fields='<?php echo ZEND_JSON::encode($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getNameFields());?>
' method="POST"><div class="contents"><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL_LIST'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL_LIST']->_loop = false;
...
' /><div class="row"><h4 class="col-xs-8"><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['BLOCK_LABEL_KEY']->value;?>
...
">Edit</a></div></div></div></div><hr><div class="blockData row"><table class="table detailview-table no-border"><tbody><?php $_smarty_tpl->tpl_vars['COUNTER'] = new Smarty_variable(0, null, 0);?><tr><?php  $_smarty_tpl->tpl_vars['FIELD_MODEL'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['FIELD_MODEL']->_loop = false;
