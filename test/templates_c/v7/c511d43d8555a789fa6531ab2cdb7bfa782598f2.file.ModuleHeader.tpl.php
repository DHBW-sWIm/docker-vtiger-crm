<?php /* Smarty version Smarty-3.1.7, created on 2020-07-30 19:16:38
         compiled from "/var/www/html/vtiger/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6609564235f183e0e7318a1-38234150%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c511d43d8555a789fa6531ab2cdb7bfa782598f2' => 
    array (
      0 => '/var/www/html/vtiger/includes/runtime/../../layouts/v7/modules/Vtiger/ModuleHeader.tpl',
      1 => 1596136576,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '6609564235f183e0e7318a1-38234150',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5f183e0e7fe2e',
  'variables' => 
  array (
    'MODULE' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_5f183e0e7fe2e')) {function content_5f183e0e7fe2e($_smarty_tpl) {?>
...
&app=<?php echo $_smarty_tpl->tpl_vars['SELECTED_MENU_CATEGORY']->value;?>
"'<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
" aria-hidden="true"></div>&nbsp;&nbsp;<?php if ($_smarty_tpl->tpl_vars['MODULE']->value==='Contacts'){?>Kontakt hinzufügen<?php }else{ ?><?php echo vtranslate($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
<?php }?></button></li><?php }?><?php } ?><?php if (count($_smarty_tpl->tpl_vars['MODULE_SETTING_ACTIONS']->value)>0){?><li><div class="settingsIcon"><button type="button" class="btn btn-default module-buttons dropdown-toggle" data-toggle="dropdown" aria-expanded="false" title="<?php echo vtranslate('LBL_SETTINGS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
