<?php /* Smarty version Smarty-3.1.7, created on 2020-07-22 15:40:42
         compiled from "/var/www/html/vtiger/includes/runtime/../../layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5121723955f183e0e62ccf4-93143866%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2428ad5810610682f76e3dd6b1050e0a837637cb' => 
    array (
      0 => '/var/www/html/vtiger/includes/runtime/../../layouts/v7/modules/Vtiger/partials/SidebarAppMenu.tpl',
      1 => 1595432435,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '5121723955f183e0e62ccf4-93143866',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5f183e0e6dc6a',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5f183e0e6dc6a')) {function content_5f183e0e6dc6a($_smarty_tpl) {?>
...
<div class="app-menu hide" id="app-menu">
	<div class="container-fluid">
		...
		<?php $_smarty_tpl->tpl_vars['ACCOUNTS_MODULE_MODEL'] = new Smarty_variable(Vtiger_Module_Model::getInstance('Accounts'), null, 0);?>
		<?php $_smarty_tpl->tpl_vars['LEADS_MODULE_MODEL'] = new Smarty_variable(Vtiger_Module_Model::getInstance('Leads'), null, 0);?>
		<?php $_smarty_tpl->tpl_vars['POTENTIALS_MODULE_MODEL'] = new Smarty_variable(Vtiger_Module_Model::getInstance('Potentials'), null, 0);?>
		<?php $_smarty_tpl->tpl_vars['CONTACTS_MODULE_MODEL'] = new Smarty_variable(Vtiger_Module_Model::getInstance('Contacts'), null, 0);?>
...
">
			...
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['LEADS_MODULE_MODEL']->value->getId())){?>
				<div class="menu-item app-item dropdown-toggle" data-default-url="<?php echo $_smarty_tpl->tpl_vars['LEADS_MODULE_MODEL']->value->getDefaultUrl();?>
">
					<div class="menu-items-wrapper">
			...
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['POTENTIALS_MODULE_MODEL']->value->getId())){?>
				<div class="menu-item app-item dropdown-toggle" data-default-url="<?php echo $_smarty_tpl->tpl_vars['POTENTIALS_MODULE_MODEL']->value->getDefaultUrl();?>
">
					<div class="menu-items-wrapper">
						<span class="app-icon-list fa fa-user"></span>
						<span class="app-name textOverflowEllipsis"> <?php echo vtranslate('Potentials',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span>
					</div>
				</div>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['ACCOUNTS_MODULE_MODEL']->value->getId())){?>
				<div class="menu-item app-item dropdown-toggle" data-default-url="<?php echo $_smarty_tpl->tpl_vars['ACCOUNTS_MODULE_MODEL']->value->getDefaultUrl();?>
">
					<div class="menu-items-wrapper">
						<span class="app-icon-list fa fa-building-o"></span>
						<span class="app-name textOverflowEllipsis"> <?php echo vtranslate('Accounts',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span>
					</div>
				</div>
			<?php }?>
			<?php if ($_smarty_tpl->tpl_vars['USER_PRIVILEGES_MODEL']->value->hasModulePermission($_smarty_tpl->tpl_vars['CONTACTS_MODULE_MODEL']->value->getId())){?>
				<div class="menu-item app-item dropdown-toggle" data-default-url="<?php echo $_smarty_tpl->tpl_vars['CONTACTS_MODULE_MODEL']->value->getDefaultUrl();?>
">
					<div class="menu-items-wrapper">
						<span class="app-icon-list vicon-leads"></span>
						<span class="app-name textOverflowEllipsis"> <?php echo vtranslate('Contacts',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</span>
					</div>
				</div>
			<?php }?>
